...
**********************************************************************   
      ...
      qdir(3)='z'
      ibgfversion=200
      icell=icellset(nprob)   !Erik Neyts suggestion May 24 2011
...
*     if (icell.ne.icellold) then   !Erik Neyts suggestion May 24 2011
      if (icell.eq.0) write (nunit1,2033)
      if (icell.gt.0) write (nunit1,2034)ncellopt
*     end if   !Erik Neyts suggestion May 24 2011
      end if
